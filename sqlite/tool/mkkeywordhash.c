...
static Keyword aKeywordTable[] = {
  ...
  { "RETROACTIVELY",     "TK_RETROACTIVELY",     ALWAYS,     0      },
...
#if defined(SQLITE_BUILDING_FOR_COMDB2)
  printf("static const unsigned short aKWNext[%d] = {0,\n", nKeyword+1);
#else /* defined(SQLITE_BUILDING_FOR_COMDB2) */
...
#if defined(SQLITE_BUILDING_FOR_COMDB2)
  printf("static const unsigned short aKWCode[%d] = {0,\n", nKeyword+1);
#else /* defined(SQLITE_BUILDING_FOR_COMDB2) */
