             ...
             int endfile, int endoff)
{
    ...
    int rectypes[] = {
        ...
        DB_llog_savegenid,
        DB_llog_scdone,
        DB_llog_undo_add_dta,
        DB_llog_undo_add_ix,
        DB_llog_ltran_commit,
        DB_llog_ltran_start,
        DB_llog_ltran_comprec,
        DB_llog_undo_del_dta,
        DB_llog_undo_del_ix,
        DB_llog_undo_upd_dta,
        DB_llog_undo_upd_ix,
        DB_llog_repblob,
        DB_llog_undo_add_dta_lk,
        DB_llog_undo_add_ix_lk,
        DB_llog_undo_del_dta_lk,
        DB_llog_undo_del_ix_lk,
        DB_llog_undo_upd_dta_lk,
        DB_llog_undo_upd_ix_lk,
    };
